...
public class LeaderZooKeeperServer extends QuorumZooKeeperServer {
    ...
    protected void setupRequestProcessors() {
        // LeaderRequestProcessor -> PrepRequestProcessor -> [wal]ProposalRequestProcessor(SyncRequestProcessor) -> CommitProcessor -> ToBeAppliedRequestProcessor -> FinalRequestProcessor
